...
RSpec.describe QuestionsController, type: :controller do
  ...
  let(:my_question) { Question.create!(title: RandomData.random_title, body: RandomData.random_question, resolved: false) }
  ...
  describe "POST create" do
    it "increases the number of Question by 1" do
      expect{ post :create, params: { question: { title: RandomData.random_title, body: RandomData.random_question, resolved: false } } }.to change(Question,:count).by(1)
    end

    it "assigns the new question to @question" do
      post :create, params: { question: { title: RandomData.random_title, body: RandomData.random_question, resolved: false } }
