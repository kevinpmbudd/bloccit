class SponsoredPostsController < ApplicationController
  def show
    @sponsored_post = SponsoredPost.find_by(id: params[:id])
  end
  ...
  def create
    @sponsored_post = SponsoredPost.new( params_for_sponsored_post )
    @topic = Topic.find_by(id: params[:topic_id])
  ...
  def update
    ...
    if @sponsored_post.save
      ...
      flash.now[:alert] = "There was an error saving the sponsored post."
      render :edit
    end
  end
